...
public class AdministracionService {
	...
	private PropietarioRepositorio propietarioRepositorio;
		...
		public void CrearAdministracion(String direccion, String idu, String idp) throws ErrorServicio{
			...
			Optional<Propietario> respuesta1 = propietarioRepositorio.findById(idp);
			...
			administracion.setPropietario(respuesta1.get());
		...
		public void ModificarAdministracion (String id, String nombre, String apellido, String contrasenia, String email, String direccion, String idp) throws ErrorServicio  {
